...
# También puede resetear este valor y al hacerlo se pone en cero. Además es posible indicar directamente un número nuevo que reemplace al 
# valor actual. Este objeto debe entender los siguientes mensajes:
# - inc()
# - dis()
# - reset()
# - valorActual()
